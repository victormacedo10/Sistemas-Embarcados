...
```
	...
	Rasp: Escreve 1
	MSP: Le 1
	MSP: Escreve LSB da amostra
	Rasp: Le LSB da amostra
	Rasp: Escreve 2
	MSP: Le 2
	MSP: Escreve MSB da amostra
	Rasp: Le MSB da amostra
	Rasp: Incrementa m ate receber 1000 amostras
	Rasp: Calcula e printa valor medio
```
...
```
	500kHz, Raspberry Pi mestre e o MSP430 escravo
```
(d) Quantas médias das amostras serão apresentadas no terminal? Justifique.
```
	50. Toda vez que uma media é mostrada o contador ms é incrementado, quando esse contador chega em M (50), o arquivo do SPI é fechado e o programa se encerra
```
